...
int orientation = - 1;   // the board's orientation
  ...
  */
  ...
  PinkyVal = map(RingVal, 930, 960, 0, 360);
  PinkyVal = PinkyVal / 2;
  ...
  Serial1.print("/");
  Serial1.println(ThumbVal);
  Serial1.print("/");
  Serial1.println(PointerVal);
  Serial1.print("/");
  Serial1.println(MiddleVal);
  Serial1.print("/");
  Serial1.println(RingVal);
  Serial1.print("/");
  Serial1.println(PinkyVal);
  Serial1.print("/");
  Serial1.println(ElbowVal);
  Serial1.print("/");
